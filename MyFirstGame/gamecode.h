...
#pragma once //REQUIRE THIS TO NOT DUPLICATE INCLUDES 
#include "errortype.h"
#include "windows.h"
...
private:
	...
	float speed;
	GameTimer gt;
	const float FRICTION = 0.8f; //these are set as you dont usually want numbers and you want constants inside your program isntead	
